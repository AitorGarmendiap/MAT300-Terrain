...
namespace mat300_terrain {
    ...
    private:
        ...
        bool Guizmo(glm::vec3* position, const glm::mat4& v, const glm::mat4& p, bool onylY);
        void SelectRiver(float mouseX, float mouseY);
        void SelectPatch(float mouseX, float mouseY);
        bool PatchIntersection(glm::vec3 origin, glm::vec3 dir, const Patch& patch);
        int PointIntersection(glm::vec3 origin, glm::vec3 dir, const Patch& patch, float radius = 5.f);
